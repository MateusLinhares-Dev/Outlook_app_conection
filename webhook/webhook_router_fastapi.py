...
from app_pescanova.api.xml_newWorkflowEditData import new_workflow_edit_data
...
async def process_notification(message_id):
    try:
        ...
        for xml_index in xml_attachments:
            ...
            # Log para garantir que a tarefa foi concluída
